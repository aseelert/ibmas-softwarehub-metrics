...
SUPPORTED_SERVICES_CATALOG = [
    ...
    {"id": "replication", "name": "Data Replication", "category": "Data Integration", "notes": "May use license-type selection with cpd-cli get-license/install docs.", "dependencies": ["ccs", "zen"], "default_limit_vpc": 16},
    {"id": "datastage_ent", "name": "DataStage Enterprise", "category": "Data Integration", "notes": "Auto-installed by WKC/IKC data quality and watsonx.data Premium/intelligence.", "dependencies": ["ccs", "zen"], "default_limit_vpc": 24},
    ...
    {"id": "streamsets", "name": "IBM StreamSets", "category": "Data Integration", "notes": "StreamSets cartridge.", "dependencies": ["ccs", "zen"], "default_limit_vpc": 16},
    ...
    {"id": "watsonx_data", "name": "watsonx.data", "category": "Lakehouse", "notes": "Auto-installs Analytics Engine; use standard/non-premium unless entitlement says Premium.", "dependencies": ["analyticsengine"], "default_limit_vpc": 48},
    {"id": "watsonx_data_premium", "name": "watsonx.data Premium", "category": "Lakehouse", "notes": "Auto-installs UDP and watsonx.data intelligence stack including dataproduct, DataStage, IKC Premium, and lineage.", "dependencies": ["udp", "watsonx_dataintelligence", "dataproduct", "datastage_ent", "ikc_premium", "datalineage"], "default_limit_vpc": 64},
    {"id": "watsonx_dataintegration", "name": "watsonx.data integration", "category": "Data Integration", "notes": "watsonx.data integration service.", "dependencies": ["ccs", "zen"], "default_limit_vpc": 16},
    {"id": "watsonx_dataintelligence", "name": "watsonx.data intelligence", "category": "Data Intelligence", "notes": "Auto-installs dataproduct, DataStage, IKC Premium, and data lineage.", "dependencies": ["dataproduct", "datastage_ent", "ikc_premium", "datalineage"], "default_limit_vpc": 48},
...
DEPENDENCY_EXPLORER_CATALOG = {
    "nodes": [
        ...
        {"id": "watsonx_data", "label": "watsonx.data standard", "type": "core_product", "metering": "RU/VPC as reported by License Service", "certainty": "IBM release license pages"},
        {"id": "analyticsengine", "label": "Analytics Engine", "type": "dependency", "metering": "Count only if License Service reports row", "certainty": "component dependency table"},
        {"id": "lite_milvus", "label": "Lite Milvus", "type": "optional_install_option", "metering": "Do not infer Premium", "certainty": "install-options YAML / IBM install options"},
        ...
        {"id": "wkc", "label": "IBM Knowledge Catalog", "type": "core_product", "metering": "Knowledge Catalog unless License Service reports Standard/Premium", "certainty": "IBM license pages"},
        {"id": "data_quality", "label": "Data Quality", "type": "optional_install_option", "metering": "Can use DataStage; not standalone DataStage unless entitled", "certainty": "IBM install option name + local repo template"},
        {"id": "knowledge_graph", "label": "Knowledge Graph", "type": "optional_install_option", "metering": "Catalog option; confirm entitlement/product row", "certainty": "IBM install option name + local repo template"},
        {"id": "datastage_ent", "label": "DataStage Enterprise", "type": "dependency_or_product", "metering": "Restricted DQ dependency unless product row/entitlement says standalone", "certainty": "IBM component catalog + local install notes"},
        {"id": "datalineage", "label": "Data Lineage / MANTA", "type": "integrated_add_on", "metering": "Separate lineage capability", "certainty": "IBM component ID pages / license pages"},
        {"id": "watsonx_dataintelligence", "label": "watsonx.data intelligence", "type": "integrated_add_on", "metering": "Separate add-on / product row; not base watsonx.data", "certainty": "IBM component ID pages / release pages"},
        {"id": "dataproduct", "label": "Data Product Hub", "type": "integrated_add_on_dependency", "metering": "Count only if reported", "certainty": "component dependency context"},
        {"id": "ikc_premium", "label": "IBM Knowledge Catalog Premium", "type": "premium_reference", "metering": "Premium only when explicitly entitled", "certainty": "IBM license pages"},
        {"id": "watsonx_ai", "label": "watsonx.ai", "type": "separate_product", "metering": "Separate service/product row", "certainty": "component dependency context"},
        {"id": "udp", "label": "Unstructured Data Integration", "type": "genai_data_add_on", "metering": "Separate add-on/dependency context", "certainty": "component dependency context"},
        {"id": "watsonx_data_premium", "label": "watsonx.data Premium", "type": "premium_reference", "metering": "Use only when entitlement and License Service say Premium", "certainty": "IBM Premium LI reference"}
    ],
    "edges": [
        ...
        {"from": "software_hub", "to": "watsonx_data", "relationship": "deploys_product", "license_boundary": "Standard/non-premium by default."},
        ...
        {"from": "watsonx_data", "to": "opensearch", "relationship": "platform_dependency", "license_boundary": "Supporting service; avoid double counting."},
        {"from": "software_hub", "to": "wkc", "relationship": "deploys_product", "license_boundary": "Base Knowledge Catalog label unless License Service says Standard/Premium."},
        {"from": "wkc", "to": "data_quality", "relationship": "optional_install_option", "license_boundary": "Data quality option can explain DataStage pods."},
        {"from": "wkc", "to": "knowledge_graph", "relationship": "optional_install_option", "license_boundary": "Catalog option; verify entitlement and reported product row."},
        {"from": "data_quality", "to": "datastage_ent", "relationship": "restricted_dependency", "license_boundary": "Do not present as standalone DataStage unless separately entitled/reported."},
        {"from": "wkc", "to": "datalineage", "relationship": "integrated_add_on", "license_boundary": "Lineage/MANTA is separate capability, not generic DQ."},
        {"from": "watsonx_dataintelligence", "to": "dataproduct", "relationship": "integrated_dependency", "license_boundary": "Data intelligence add-on stack; verify product row."},
        {"from": "watsonx_dataintelligence", "to": "datastage_ent", "relationship": "integrated_dependency", "license_boundary": "Dependency/add-on context; verify product row."},
        {"from": "watsonx_dataintelligence", "to": "ikc_premium", "relationship": "integrated_dependency", "license_boundary": "Premium catalog is not base WKC."},
        {"from": "watsonx_dataintelligence", "to": "datalineage", "relationship": "integrated_dependency", "license_boundary": "Lineage remains separately visible."},
        {"from": "watsonx_data_premium", "to": "watsonx_dataintelligence", "relationship": "premium_reference_stack", "license_boundary": "Premium reference only when entitlement says Premium."},
        {"from": "watsonx_data_premium", "to": "udp", "relationship": "premium_reference_stack", "license_boundary": "Do not attach to standard watsonx.data without entitlement evidence."},
        {"from": "udp", "to": "watsonx_ai", "relationship": "genai_dependency_context", "license_boundary": "watsonx.ai is a separate service/product context."}
    ],
    "sources": [
        "https://www.ibm.com/docs/en/software-hub/5.4.x?topic=services-specifying-installation-options",
        "https://www.ibm.com/docs/en/software-hub/5.3.x?topic=services-specifying-installation-options",
...
KNOWN_SERVICES_CATALOG = {
    ...
    "wkc": {
        ...
        "tier": "Core Service",
        "edition_options": ["Knowledge Catalog", "Knowledge Catalog Premium only when explicitly entitled"],
        "license_rule": "Display the installed service as IBM Knowledge Catalog unless IBM License Service reports a Standard or Premium cartridge product row. IBM license pages publish Knowledge Catalog Standard and Premium LI documents, but the dashboard must not manually upgrade the installed service label. Premium/model-driven capabilities are separate and can involve enableModelsOn: gpu/remote/cpu options.",
        "dependencies": ["ccs", "zen", "opencontent_opensearch", "datastage"],
    ...
    "datastage": {
        ...
        "tier": "Core / Cartridge",
        "edition_options": ["Standalone Enterprise Cartridge", "WKC Data Quality Bundle"],
        "license_rule": "If present only for WKC data quality execution, treat it as restricted to that purpose unless License Service and entitlement records show a standalone DataStage cartridge.",
    ...
    "lineage": {
        ...
        "edition_options": ["Standard", "Enterprise Scanner Bundle"],
        "license_rule": "MANTA/Data Lineage is tracked as its own lineage capability. Keep it separate from WKC data quality enablement and use the product row reported by License Service.",
        "dependencies": ["wkc", "ccs", "zen"],
    ...
    "analyticsengine": {
        ...
        "tier": "Compute Engine",
        "edition_options": ["Serverless Spark"],
        "license_rule": "Meter according to the IBM License Service product metric. Spark driver/executor CPU and memory are operational sizing evidence.",
        "dependencies": ["ccs", "zen"],
        "default_limit_vpc": 16,
        "default_scale": "small",
...
class ClusterTelemetryCollector:
    ...
    def get_license_service_data(self) -> Dict[str, Any]:
        ...
        if not host or not token_b64:
            products = [
                {"name": "IBM watsonx.data", "id": "ibm-watsonx-data", "metricName": "RU", "metricQuantity": 420.0, "status": "Sample", "edition": "Standard / non-premium", "release": "2.3.x / 2.4.x"},
                {"name": "IBM Knowledge Catalog", "id": "ibm-knowledge-catalog", "metricName": "VPC", "metricQuantity": 24.5, "status": "Sample", "edition": "Knowledge Catalog", "release": "5.3 / 5.4"},
                {"name": "IBM DataStage Enterprise Cartridge", "id": "ibm-datastage-ent", "metricName": "VPC", "metricQuantity": 18.0, "status": "Sample", "edition": "Restricted DQ dependency unless separately entitled", "release": "15.3 / 15.4"},
                {"name": "IBM Manta Data Lineage Cartridge", "id": "ibm-manta-lineage", "metricName": "VPC", "metricQuantity": 8.0, "status": "Sample", "edition": "Lineage cartridge", "release": "5.3 / 5.4"},
                {"name": "IBM Analytics Engine", "id": "ibm-analytics-engine", "metricName": "VPC", "metricQuantity": 12.0, "status": "Sample", "edition": "Spark service", "release": "5.3 / 5.4"},
            ]
    ...
    def get_cluster_overview(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "cluster_info": {
                ...
                "storage_class": os.environ.get("NFS_STORAGE_CLASS", "managed-nfs-storage"),
                "nfs_server": os.environ.get("NFS_SERVER_LOCATION", "10.10.0.40"),
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cds--neo-node.is-selected circle {
    ...
    stroke-width: 4;
    filter: drop-shadow(0 6px 16px rgba(15,98,254,0.34));
  }
  .cds--neo-node.is-focus circle {
    stroke: #ffffff;
    stroke-width: 5;
    animation: cdsNodePulse 2s ease-in-out infinite;
  }
  .cds--neo-node text {
    fill: var(--cds-text-primary);
    font-size: 11px;
  ...
  @keyframes cdsNodePulse {
    0%, 100% { filter: drop-shadow(0 4px 12px rgba(15,98,254,0.28)); }
    50% { filter: drop-shadow(0 8px 22px rgba(15,98,254,0.55)); }
  }
  .cds--neo-side {
    background: var(--cds-layer-01);
    padding: var(--cds-spacing-05);
...
<main class="cds--grid">
  ...
  <div class="cds--action-bar">
    ...
    <div style="font-size:12px; color:var(--cds-text-secondary);">
      Dynamic Storage: <code class="cds--snippet" id="nfs-spec">managed-nfs-storage @ 10.10.0.40</code>
    </div>
  </div>
...
function layoutLineage(selectedId) {
  ...
  const parents = edges.filter(edge => edge.to === selectedId).map(edge => edge.from);
  const children = edges.filter(edge => edge.from === selectedId).map(edge => edge.to);
  const grandchildren = edges
    .filter(edge => children.includes(edge.from))
    .map(edge => edge.to)
    .filter(id => id !== selectedId && !parents.includes(id) && !children.includes(id));
  const columns = [
    { role: 'upstream', x: 150, ids: parents },
    { role: 'selected', x: 405, ids: [selectedId] },
    { role: 'dependencies', x: 650, ids: children },
    { role: 'next', x: 875, ids: grandchildren.slice(0, 6) }
  ];
  const positioned = {};
  columns.forEach(column => {
    const unique = [...new Set(column.ids)].filter(id => nodesById[id]);
    const spacing = 420 / Math.max(unique.length, 1);
    unique.forEach((id, index) => {
      positioned[id] = {
        ...nodesById[id],
        x: column.x,
        y: unique.length === 1 ? 260 : 70 + spacing * index + spacing / 2,
        role: column.role
      };
    });
  });
...
function drawDependencyLineage(selectedId) {
  ...
  const linkHtml = lineage.edges.map((edge) => {
    ...
    const edgeIndex = dependencyExplorerState.edges.indexOf(edge);
    const x1 = fromNode.x + 38;
    const y1 = fromNode.y;
    const x2 = toNode.x - 38;
    const y2 = toNode.y;
    const cx = (x1 + x2) / 2;
    const important = edge.relationship.includes('premium') || edge.relationship.includes('restricted');
    const selectedPath = edge.from === lineage.selectedId || edge.to === lineage.selectedId;
    const className = `cds--neo-link ${important ? 'is-emphasis' : ''} ${selectedPath ? 'is-selected-path' : ''}`;
    return `<path class="${className}" d="M ${x1} ${y1} C ${cx} ${y1}, ${cx} ${y2}, ${x2} ${y2}" onclick="showDependencyEdge(${edgeIndex})"><title>${esc(edge.relationship)}</title></path>`;
  }).join('');
  const nodeHtml = lineage.nodes.map(node => {
    ...
    return `
      <g class="cds--neo-node ${node.id === lineage.selectedId ? 'is-focus is-selected' : ''}" data-node-id="${esc(node.id)}" onclick="showDependencyNode('${esc(node.id)}')" transform="translate(${node.x} ${node.y})">
        ...
        <text y="${radius + 16}" text-anchor="middle">${esc(compactLabel(node.label, 24))}</text>
        <text class="cds--node-type" y="${radius + 30}" text-anchor="middle">${esc(compactLabel(status, 24))}</text>
      </g>
    `;
  }).join('');
  svg.innerHTML = `
...
function renderDashboard(data) {
  ...
  document.getElementById('nfs-spec').innerText = `${cluster.storage_class} @ ${cluster.nfs_server}`;
  ...
  root.innerHTML = `
    ...
    <div class="cds--neo-layout">
      <div class="cds--neo-canvas">
        <svg id="dependency-graph-svg" viewBox="0 0 980 520" role="img" aria-label="Interactive product dependency graph"></svg>
      </div>
